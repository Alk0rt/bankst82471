...
class LoginForm(tk.Toplevel):
    def __init__(self, master=None, db=None, on_success=None, on_back=None):
        ...
        self.title_label = tk.Label(main_frame, text="Login to Your Account", **style["TitleLabel"])
        ...
        self.login_button = tk.Button(main_frame, text="Login", command=self.login, **style["TButton"])
